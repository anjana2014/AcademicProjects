...
def main():
	...
	for i in range(X_input.shape[0]):
		...
		loss, grad = weighted_squared_loss(X_input, Y_train_np, w, query=query)
		num_grad = numericalgrad(weighted_squared_loss, X_input, Y_train_np, w, query, 1e-5)
		...
		w_learned = gd_with_backtracking_v4(X_input, Y_train_np,query, weighted_squared_loss, 0, 1e-4, 1e-5)
	...
	plt.title('Q2AB_Learned_Function')
	plt.legend()
	plt.savefig("Q2B_Visualization.jpg")
	print('END Q2_AB\n')
